...
Route::middleware(['auth:sanctum'])->group(function(){
    ...
    Route::get('/transactions/{id}', [TransactionController::class, 'showTransaction']); // Entradas ou saídas
    Route::get('/transactions/type/{id}', [TransactionController::class, 'showTypeTransactions']); // Entradas ou saídas
